            ...
            <div class="footer-top">
                ...
                <div class="footer-brand">
                    <div class="footer-logo">
                        <span class="logo-text">ba<span>/</span>anz</span>
                        <span class="logo-tagline"><?php echo esc_html(get_field('site_tagline', 'option') ?: 'smart food for busy people'); ?></span>
                    </div>
                    
                    <div class="footer-store-buttons">
                        <?php if ($app_store = get_field('app_store_link', 'option')): ?>
                        <a href="<?php echo esc_url($app_store); ?>" class="store-button" target="_blank" rel="noopener">
                        ...
                        <?php if ($google_play = get_field('google_play_link', 'option')): ?>
                        <a href="<?php echo esc_url($google_play); ?>" class="store-button" target="_blank" rel="noopener">
                            <svg class="store-icon" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div class="footer-links">
                    <nav class="footer-nav">
                        <ul class="footer-nav-list">
                            ...
                            <li><a href="<?php echo get_permalink(get_page_by_path('about-us')); ?>" class="footer-nav-link">About Us</a></li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="footer-social">
                    ...
                    <a href="<?php echo esc_url($instagram); ?>" class="social-link" target="_blank" rel="noopener" aria-label="Instagram">
