        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-apps">
                    ...
                    if ($app_store): ?>
                        <a href="<?php echo esc_url($app_store); ?>" class="app-link app-store" target="_blank" rel="noopener">
                            <span>Скачать в App Store</span>
                        </a>
                    <?php endif;
                    
                    if ($google_play): ?>
                        <a href="<?php echo esc_url($google_play); ?>" class="app-link google-play" target="_blank" rel="noopener">
                ...
                <div class="footer-social">
                    ...
                    if ($instagram || $telegram || $facebook): ?>
